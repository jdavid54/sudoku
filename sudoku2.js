...
function makegrid(array) {	// crée la grille avec candidates
	content='';
	content+='<style>td {font-family:arial; border: 1px solid black; font-size:12px; text-align:left; vertical-align:top; width:40px; height:40px;} .found {font-weight:bold;font-size:20px;text-align:center; vertical-align:middle;} div{display:inline; float:left;} p {font-family:arial; font-size:12px;} .grey {background-color:#f1eeee;}</style>';
